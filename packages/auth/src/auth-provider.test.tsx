...
const ME_A = {
  ...
  capabilities: {
    ...
    devicePhysicalCheckItemRead: true,
    devicePhysicalCheckItemCreate: true,
    devicePhysicalCheckItemUpdate: true,
    devicePhysicalCheckItemDelete: true,
    deviceRead: true,
    deviceCreate: true,
    deviceUpdate: true,
    deviceDelete: true,
...
const ME_B = {
  ...
  capabilities: {
    ...
    devicePhysicalCheckItemRead: false,
    devicePhysicalCheckItemCreate: false,
    devicePhysicalCheckItemUpdate: false,
    devicePhysicalCheckItemDelete: false,
    deviceRead: false,
    deviceCreate: false,
    deviceUpdate: false,
    deviceDelete: false,
