...
const ROWS: MenuSeedRow[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // Leads Management (group) → order: 1
  // ─────────────────────────────────────────────────────────────────────────
  {
    application: "MANAGEMENT",
    code: "leads",
  ...
  {
    application: "MANAGEMENT",
    code: "device-management.device-type-aliases",
    parentCode: "device-management.devices",
    label: "Name Aliases",
    href: "/device-type-aliases",
    icon: "tags",
    order: 1,
    viewResource: "deviceTypeAlias",
    viewAction: "read",
  },
  {
  ...
  {
    application: "MANAGEMENT",
    code: "calibration-management.calibration-jobs",
    parentCode: "calibration-management",
    label: "Calibration Job",
    href: "/calibration-jobs",
    icon: "activity",
    order: 6,
