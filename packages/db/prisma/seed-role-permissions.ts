...
const PRESERVED_BASELINE: GrantRow[] = [
  ...
  { role: "ADMIN", resource: "deviceManufacturer", action: "read" },
  { role: "ADMIN", resource: "deviceManufacturer", action: "create" },
  { role: "ADMIN", resource: "deviceManufacturer", action: "update" },
  { role: "ADMIN", resource: "deviceManufacturer", action: "delete" },
  ...
  // DevicePhysicalCheckItem Master Data (Portal Physical Inspection, 2026-09-10)
